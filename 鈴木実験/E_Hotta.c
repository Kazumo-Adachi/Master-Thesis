...
/* ========= H_IN の定義（FLUME_ID と Q_ID の組み合わせで切り替え） ========= */
...
#define OUTPUT_DIR       "堀田侵食/HE_" GRAIN_NAME "_" FLUME_NAME "_" Q_NAME "/"
#define OUTPUT_PREFIX    "堀田侵食_" GRAIN_NAME "_" FLUME_NAME "_" Q_NAME "_"
