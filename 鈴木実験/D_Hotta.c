...
#define Q_ID        1       /* 流量: 1=Q_STD, 2=Q_HIGH, 3=Q_LOW */
/* ================================================================ */
...
#define OUTPUT_DIR       "堀田堆積/HD_" GRAIN_NAME "_" FLUME_NAME "_" Q_NAME "/"
#define OUTPUT_PREFIX    "堀田堆積_" GRAIN_NAME "_" FLUME_NAME "_" Q_NAME "_"
...
int main(void) {
    ...
    for (n = 0; n < T_GRID; n++) {
        ...
        if (n < INFLOW_TIME/(2*dt)) {
            ...
            M1[0] = Mo; M2[0] = Mo;
            u1[0] = uo; u2[0] = uo;
            c1[0] = co; c2[0] = ro*tan(15*M_PI/180)/(sigma-ro)/(tanfais-tan(15*M_PI/180));
            ct[0] = co;
        }
        else {
            h1[0] = 0; h2[0] = 0;
        ...
        for (i = 1; i < X_GRID; i++) {
            ...
            if (h2[i] < stop) {
                ...
                if (c2[i] > c_min){
                    ...
                    if (Pex/Pmax >= 1) Pex = Pmax;
                    if (Pex - Pmin <= EPS) Pex = Pmin;
